...
REPLIES = (
    ...
    "ещё пара таких сообщений и я приглашу тебя на виртуальное свидание 😏",
    "за такой комментарий полагается виртуальный поцелуй",
    "кажется между нами намечается опасно хорошая химия",
    "с тобой хочется говорить чуть ближе и немного тише",
    "бокалы готовы, осталось выбрать музыку 🥂",
    "если продолжишь так флиртовать, я начну отвечать взаимностью",
    "может продолжим этот разговор при виртуальных свечах?",
    "у меня есть свободный вечер и подозрительно хорошее настроение",
    "ты приносишь в этот чат слишком много обаяния",
    "кажется нам пора перейти на язык красивых намёков",
    "не знаю что ты задумал, но звучит как приглашение 😏",
    "предлагаю сделать вид что вокруг никого нет",
    "ещё одно такое сообщение и я попрошу оставить нас наедине с комментариями",
    "с тобой даже паузы звучали бы красиво",
    "в этом диалоге уже не хватает только тихой музыки и двух бокалов",
    "кажется я нашёл с кем провести виртуальный вечер 🍾",
    "ты говори, а я буду смотреть особенно внимательно",
    "за такое обаяние можно получить место рядом со мной",
    "похоже у нас совпали не только мнения",
    "давай не будем скрывать, этот разговор нам обоим нравится",
    "у тебя талант превращать обычный чат в маленькое свидание",
    "могу предложить тебе лучший столик в моих уведомлениях",
    "не приближайся так быстро, я ещё не успел сделать серьёзный вид",
    "твоё сообщение звучит как повод задержаться до позднего вечера",
    "если бы здесь были свечи, я бы уже их зажёг",
    "кажется расстояние между нашими сообщениями пора сокращать",
    "ты оставляешь мне слишком мало шансов не флиртовать",
    "давай продолжим, мне нравится эта опасно милая атмосфера",
    "можно я отвечу тебе чуть нежнее чем планировал?",
    "с таким собеседником хочется отключить все остальные уведомления",
    "это уже не просто комментарии, это наша маленькая сцена",
    "ты умеешь делать так, чтобы хотелось остаться ещё на одно сообщение",
    "поймал твой намёк и отправляю свой в ответ 😏",
    "если это игра взглядов, то я не отвожу свой",
    "между строк сейчас было что-то очень симпатичное",
    "подвинься, я сяду рядом хотя бы в этом чате",
    "кажется у этого разговора есть романтический потенциал",
    "давай поднимем бокалы за наше подозрительно удачное знакомство 🥂",
    "у меня для тебя припасён комплимент, но сначала напиши ещё",
    "не обещаю вести себя серьёзно рядом с такими сообщениями",
    "твой стиль общения явно создан для красивых вечеров",
    "может оставим логику и просто продолжим флиртовать?",
    "мне уже нравится версия вечера, где мы продолжаем этот разговор",
    "ты сейчас так написал, будто хочешь получить персональный комплимент",
    "если позовёшь на виртуальную прогулку, я сделаю вид что долго думал",
    "кажется кто-то заслужил немного особенного внимания",
    "давай будем честны, мы оба ждали следующего сообщения",
    "с тобой даже кошелёк начинает верить в романтику",
    "я бы предложил обменяться взглядами, но придётся сообщениями",
    "ты создаёшь атмосферу, в которой хочется говорить шёпотом",
    "так и быть, оставлю тебе место в своих любимых диалогах",
    "предупреждаю, на такие сообщения я отвечаю с особой теплотой",
    "если это начало знакомства, то оно мне уже нравится",
    "тебе идёт быть причиной моей улыбки",
    "предлагаю тост за то, как красиво мы нашли друг друга в комментариях",
    "кажется этот вечер просит продолжения в том же настроении",
    "можешь написать ещё, я обещаю читать чуть ближе к сердцу",
    "твой комментарий звучит как приглашение узнать тебя получше",
    "у нас тут намёк на взаимную симпатию или мне не кажется?",
    "ещё немного такой химии и придётся бронировать виртуальное свидание",
)
